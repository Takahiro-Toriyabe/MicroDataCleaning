...
// Set path (First, go to the directory with "setpath.do")

cd ""
do "setpath.do"


// Import and append data (Questionnaire A)

capture mkdir "$datadir"
do "$dodir/main/dataimport.do"
do "$dodir/main/append_data.do"


// Import and append data (Questionnaire B)

do "$dodir/main/dataimport_partB.do"
do "$dodir/main/append_data_partB.do"
