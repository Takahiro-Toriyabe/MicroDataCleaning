capture label define Chosa_Nen 2012 "西暦"
...
capture label define Honshi 1 "単独事業所" 2 "本社" 3 "支社、新設事業所"
capture label values Honshi Honshi

capture label define Minko 4 "民営事業所" 5 "公営事業所"
capture label values Minko Minko

capture label define Syurui 1 "国" 2 "都道府県" 3 "市区町村" 4 "独立行政法人" 5 "その他"
capture label values Syurui Syurui
