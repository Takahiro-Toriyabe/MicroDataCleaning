...
global DoFilePathTemp = "D:/GitHub/MicroDataCleaning/do-file/賃金構造基本統計調査/Kojin"
...
save "${DataFilePathTemp}/h01_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h02_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h03_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h04_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h05_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h06_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h07_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h08_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h09_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h10_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h11_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h12_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h13_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h14_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h15_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h16_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h17_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h18_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h19_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h20_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h21_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h22_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h23_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h24_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h25_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h26_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h27_k-chin_str.dta", replace
destring *, replace
...
save "${DataFilePathTemp}/h29_k-chin_str.dta", replace
destring *, replace
...
append using ///
    "${DataFilePathTemp}/h01_k-chin_str.dta" ///
    "${DataFilePathTemp}/h02_k-chin_str.dta" ///
    "${DataFilePathTemp}/h03_k-chin_str.dta" ///
    "${DataFilePathTemp}/h04_k-chin_str.dta" ///
    "${DataFilePathTemp}/h05_k-chin_str.dta" ///
    "${DataFilePathTemp}/h06_k-chin_str.dta" ///
    "${DataFilePathTemp}/h07_k-chin_str.dta" ///
    "${DataFilePathTemp}/h08_k-chin_str.dta" ///
    "${DataFilePathTemp}/h09_k-chin_str.dta" ///
    "${DataFilePathTemp}/h10_k-chin_str.dta" ///
    "${DataFilePathTemp}/h11_k-chin_str.dta" ///
    "${DataFilePathTemp}/h12_k-chin_str.dta" ///
    "${DataFilePathTemp}/h13_k-chin_str.dta" ///
    "${DataFilePathTemp}/h14_k-chin_str.dta" ///
    "${DataFilePathTemp}/h15_k-chin_str.dta" ///
    "${DataFilePathTemp}/h16_k-chin_str.dta" ///
    "${DataFilePathTemp}/h17_k-chin_str.dta" ///
    "${DataFilePathTemp}/h18_k-chin_str.dta" ///
    "${DataFilePathTemp}/h19_k-chin_str.dta" ///
    "${DataFilePathTemp}/h20_k-chin_str.dta" ///
    "${DataFilePathTemp}/h21_k-chin_str.dta" ///
    "${DataFilePathTemp}/h22_k-chin_str.dta" ///
    "${DataFilePathTemp}/h23_k-chin_str.dta" ///
    "${DataFilePathTemp}/h24_k-chin_str.dta" ///
    "${DataFilePathTemp}/h25_k-chin_str.dta" ///
    "${DataFilePathTemp}/h26_k-chin_str.dta" ///
    "${DataFilePathTemp}/h27_k-chin_str.dta" ///
    "${DataFilePathTemp}/h28_k-chin_str.dta" ///
    "${DataFilePathTemp}/h29_k-chin_str.dta" ///
