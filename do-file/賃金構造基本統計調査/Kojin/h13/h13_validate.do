...
capture assert inlist(var1, 2001, .)
if _rc!=0 {
...
if r(N)==_N {
    display as error "Only missing value: {bf:var14} (抽出産業番号)"
}
...
if r(N)==_N {
    display as error "Only missing value: {bf:var26} (大分類)"
}


capture count if var27==.
if r(N)==_N {
    display as error "Only missing value: {bf:var27} (中分類)"
}


capture count if var28==.
if r(N)==_N {
    display as error "Only missing value: {bf:var28} (小分類)"
}


capture count if var29==.
if r(N)==_N {
    display as error "Only missing value: {bf:var29} (性別)"
}
capture assert inlist(var29, 1, 2, .)
if _rc!=0 {
    display as error "WARNING: {bf:var29} (性別) may have invalid values (Check layout sheet)"
}


capture count if var30==.
if r(N)==_N {
    display as error "Only missing value: {bf:var30} (労働者の種類)"
}
capture assert inlist(var30, 1, 2, .)
if _rc!=0 {
    display as error "WARNING: {bf:var30} (労働者の種類) may have invalid values (Check layout sheet)"
}


capture count if var31==.
if r(N)==_N {
    display as error "Only missing value: {bf:var31} (雇用形態)"
}
capture assert inlist(var31, 1, 2, .)
if _rc!=0 {
    display as error "WARNING: {bf:var31} (雇用形態) may have invalid values (Check layout sheet)"
}


capture count if var32==.
if r(N)==_N {
    display as error "Only missing value: {bf:var32} (就業形態)"
}
capture assert inlist(var32, 1, 2, .)
if _rc!=0 {
    display as error "WARNING: {bf:var32} (就業形態) may have invalid values (Check layout sheet)"
}


capture count if var33==.
if r(N)==_N {
    display as error "Only missing value: {bf:var33} (学歴)"
}
capture assert inlist(var33, 1, 2, 3, 4, .)
if _rc!=0 {
    display as error "WARNING: {bf:var33} (学歴) may have invalid values (Check layout sheet)"
}


capture count if var34==.
if r(N)==_N {
    display as error "Only missing value: {bf:var34} (年齢)"
}


capture count if var35==.
if r(N)==_N {
    display as error "Only missing value: {bf:var35} (勤続年数)"
}
...
if r(N)==_N {
    display as error "Only missing value: {bf:var37} (経験年数)"
}
capture assert inlist(var37, 1, 2, 3, 4, 5, .)
if _rc!=0 {
    display as error "WARNING: {bf:var37} (経験年数) may have invalid values (Check layout sheet)"
}


capture count if var38==.
if r(N)==_N {
    display as error "Only missing value: {bf:var38} (実労働日数)"
}


capture count if var39==.
if r(N)==_N {
    display as error "Only missing value: {bf:var39} (所定内実労働時間数)"
}


capture count if var40==.
if r(N)==_N {
    display as error "Only missing value: {bf:var40} (超過実労働時間数)"
}
...
if r(N)==_N {
    display as error "Only missing value: {bf:var42} (超過労働給与額)"
}


capture count if var43==.
if r(N)==_N {
    display as error "Only missing value: {bf:var43} (所定内給与額)"
}


capture count if var44==.
if r(N)==_N {
    display as error "Only missing value: {bf:var44} (うち通勤手当)"
}


capture count if var45==.
if r(N)==_N {
    display as error "Only missing value: {bf:var45} (うち精皆勤手当)"
}


capture count if var46==.
if r(N)==_N {
    display as error "Only missing value: {bf:var46} (うち家族手当)"
}


capture count if var47==.
if r(N)==_N {
    display as error "Only missing value: {bf:var47} (賞与等特別支給額)"
}
