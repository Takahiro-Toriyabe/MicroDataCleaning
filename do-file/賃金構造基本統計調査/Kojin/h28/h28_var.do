...
capture label variable Shiku "母集団: 市区町村番号"
capture label variable Jigyousho "母集団: 共通事業所コード"
capture label variable M_Sangyo "母集団: 産業分類番号"
capture label variable M_JigyoKibo "母集団: 事業所規模"
capture label variable M_RinjiKibo "母集団: 臨時雇用者規模番号"
capture label variable M_Kigyokibo "母集団: 企業規模"
...
capture label variable Minko "母集団時の民・公区分"
