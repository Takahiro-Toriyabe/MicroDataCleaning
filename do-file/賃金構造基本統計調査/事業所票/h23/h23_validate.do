...
capture assert inlist(Nen, 2011, .)
if _rc!=0 {
...
if r(N)==_N {
    display as error "Only missing value: {bf:M_Sangyo} (産業番号)"
}
...
if r(N)==_N {
    display as error "Only missing value: {bf:Sangyo} (産業番号)"
}
