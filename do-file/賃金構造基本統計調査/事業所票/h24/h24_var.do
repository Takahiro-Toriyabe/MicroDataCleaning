...
capture label variable M_Sangyo "マスター: 産業番号"
...
capture label variable Sangyo "調査票: 産業番号"
...
capture label variable SangyoD "初任給用産業番号: 大"
capture label variable SangyoC "初任給用産業番号: 中"
capture label variable SangyoS "初任給用産業番号: 小"
