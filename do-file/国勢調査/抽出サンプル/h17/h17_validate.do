...
capture assert inlist(SETJIN_M, 0, 1, 999, .)
if _rc!=0 {
    display as error "WARNING: {bf:SETJIN_M} (男) may have invalid values (Check layout sheet)"
}
...
capture assert inlist(SETJIN_F, 0, 1, 999, .)
if _rc!=0 {
    display as error "WARNING: {bf:SETJIN_F} (女) may have invalid values (Check layout sheet)"
}
...
capture assert inlist(JIKAN, 0, 168, .)
if _rc!=0 {
    display as error "WARNING: {bf:JIKAN} (オリジナルコード) may have invalid values (Check layout sheet)"
}
