...
global DoFilePathTemp = "D:/GitHub/MicroDataCleaning/do-file/国勢調査/抽出サンプル"
...
run "${DoFilePathTemp}/s60/s60_const.do"
run "${DoFilePathTemp}/s60/s60_var.do"
save "${DataFilePathTemp}/data_str.dta", replace
destring *, replace
run "${DoFilePathTemp}/s60/s60_val.do"
run "${DoFilePathTemp}/s60/s60_validate.do"
save "${DataFilePathTemp}/data.dta", replace

clear


run "${DoFilePathTemp}/s55/s55_const.do"
run "${DoFilePathTemp}/s55/s55_var.do"
save "${DataFilePathTemp}/data_str.dta", replace
destring *, replace
run "${DoFilePathTemp}/s55/s55_val.do"
run "${DoFilePathTemp}/s55/s55_validate.do"
save "${DataFilePathTemp}/data.dta", replace
