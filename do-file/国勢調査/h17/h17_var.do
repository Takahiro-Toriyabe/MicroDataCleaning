...
capture label variable NOBETANI "世帯に関する事項延べ面積: 単位"
capture label variable NOBE "世帯に関する事項延べ面積: 延べ面積"
...
capture label variable SANSF "個人に関する事項産業抽出集計用小分類: オリジナルコード"
...
capture label variable SHOKSF "個人に関する事項職業抽出集計用小分類: オリジナルコード"
