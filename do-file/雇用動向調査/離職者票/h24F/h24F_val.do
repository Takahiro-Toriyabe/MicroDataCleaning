...
capture label define var16 1 "中学卒" 3 "専修学校卒" 5 "大学卒" 
capture label values var16 var16

capture label define var17 1 "新規学卒者(平成27年1月以降卒業)" 
capture label values var17 var17

capture label define var18 1 "一般労働者(雇用期間の定めなし)" 3 "パートタイム労働者(雇用期間の定めなし)" 
capture label values var18 var18

capture label define var19 1 "管理的職業従事者" 3 "事務従事者" 5 "サービス職業従事者" 7 "生産工程従事者" 9 "建設・採掘従事者" 11 "その他の職業従事者" 
capture label values var19 var19

capture label define var20 1 "6ヶ月未満" 3 "1~2年未満" 5 "5~10年未満" 
capture label values var20 var20

capture label define var21 1 "契約期間の満了" 3 "出向" 5 "定年" 7 "結婚" 9 "介護・看護" 11 "その他の個人的理由" 
