...
capture label variable var6 "地域番号"
...
capture label variable var19 "氏名番号"
capture label variable var20 "性別"
capture label variable var21 "年齢区分"
capture label variable var22 "最終学歴"
capture label variable var23 "最終学校卒業年区分"
capture label variable var24 "就業形態"
capture label variable var25 "仕事の内容"
capture label variable var26 "勤続期間区分"
capture label variable var27 "チェック済コード"
capture label variable var28 "離職理由コード"
