...
capture label variable var18 "氏名・番号"
capture label variable var19 "性別"
capture label variable var20 "チェック済"
capture label variable var21 "学歴"
capture label variable var22 "卒業時期"
capture label variable var23 "就業形態"
capture label variable var24 "仕事の内容"
capture label variable var25 "勤続期間"
