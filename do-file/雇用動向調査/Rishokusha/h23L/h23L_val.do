...
capture label define var14 1 "中学卒" 2 "高校卒" 3 "専修学校卒" 4 "高専・短大卒" 5 "大学卒" 6 "大学院卒" 
...
capture label define var16 1 "一般労働者(雇用期間の定めなし)" 2 "一般労働者(雇用期間の定めあり)" 3 "パートタイム労働者(雇用期間の定めなし)" 4 "パートタイム労働者(雇用期間の定めあり)" 
capture label values var16 var16

capture label define var17 1 "管理的職業従事者" 2 "専門的・技術的職業従事者" 3 "事務従事者" 4 "販売従事者" 5 "サービス職業従事者" 6 "保安職業従事者" 7 "生産工程従事者" 8 "輸送・機械運転従事者" 9 "建設・採掘従事者" 10 "運搬・清掃・包装等従事者" 11 "その他の職業従事者" 
...
capture label define var19 1 "契約期間の満了" 2 "経営上の都合" 3 "出向" 4 "出向元への復帰" 5 "定年" 6 "本人の責による" 7 "結婚" 8 "出産・育児" 9 "介護・看護" 10 "死亡・傷病" 11 "その他の個人的理由" 
