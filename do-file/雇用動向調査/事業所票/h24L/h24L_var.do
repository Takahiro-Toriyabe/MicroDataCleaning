...
capture label variable var17 "（３）常用に切り替えられた者"
...
capture label variable var23 "（３）常用に切り替えられた者"
...
capture label variable var29 "（３）常用に切り替えられた者"
...
capture label variable var35 "（３）常用に切り替えられた者"
