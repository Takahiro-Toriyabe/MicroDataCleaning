...
capture label variable var25 "常用労働者の異動状況区分2臨時・日雇名義男(2)増加常用労働者: イ入職者"
capture label variable var26 "常用労働者の異動状況区分2臨時・日雇名義男(2)増加常用労働者: ロ転入者等"
capture label variable var27 "常用労働者の異動状況区分2臨時・日雇名義男: (3)常用に切り替えられた者"
capture label variable var28 "常用労働者の異動状況区分2臨時・日雇名義男(4)減少常用労働者: イ離職者"
capture label variable var29 "常用労働者の異動状況区分2臨時・日雇名義男(4)減少常用労働者: ロ転出者等"
capture label variable var30 "常用労働者の異動状況区分2臨時・日雇名義男: (5)期末常用労働者"
capture label variable var31 "常用労働者の異動状況区分3常用名義女(2)増加常用労働者: イ入職者"
capture label variable var32 "常用労働者の異動状況区分3常用名義女(2)増加常用労働者: ロ転入者等"
capture label variable var33 "常用労働者の異動状況区分3常用名義女: (3)常用に切り替えられた者"
capture label variable var34 "常用労働者の異動状況区分3常用名義女(4)減少常用労働者: イ離職者"
capture label variable var35 "常用労働者の異動状況区分3常用名義女(4)減少常用労働者: ロ転出者等"
capture label variable var36 "常用労働者の異動状況区分3常用名義女: (5)期末常用労働者"
capture label variable var37 "常用労働者の異動状況区分4臨時・日雇名義女(2)増加常用労働者: イ入職者"
capture label variable var38 "常用労働者の異動状況区分4臨時・日雇名義女(2)増加常用労働者: ロ転入者等"
capture label variable var39 "常用労働者の異動状況区分4臨時・日雇名義女: (3)常用に切り替えられた者"
capture label variable var40 "常用労働者の異動状況区分4臨時・日雇名義女(4)減少常用労働者: イ離職者"
capture label variable var41 "常用労働者の異動状況区分4臨時・日雇名義女(4)減少常用労働者: ロ転出者等"
capture label variable var42 "常用労働者の異動状況区分4臨時・日雇名義女: (5)期末常用労働者"
...
capture label variable var115 "職業別常用労働者数区分13常用労働者: 専門・技術"
capture label variable var116 "職業別常用労働者数区分13常用労働者: 管理"
capture label variable var117 "職業別常用労働者数区分13常用労働者: 事務"
capture label variable var118 "職業別常用労働者数区分13常用労働者: 販売"
capture label variable var119 "職業別常用労働者数区分13常用労働者: サービス"
capture label variable var120 "職業別常用労働者数区分13常用労働者: 運輸・通信"
capture label variable var121 "職業別常用労働者数区分13常用労働者: 生産・労務"
capture label variable var122 "職業別常用労働者数区分13常用労働者: その他"
capture label variable var123 "職業別常用労働者数区分13常用労働者: 合計"
capture label variable var124 "職業別常用労働者数区分14うちパート: 専門・技術"
capture label variable var125 "職業別常用労働者数区分14うちパート: 管理"
capture label variable var126 "職業別常用労働者数区分14うちパート: 事務"
capture label variable var127 "職業別常用労働者数区分14うちパート: 販売"
capture label variable var128 "職業別常用労働者数区分14うちパート: サービス"
capture label variable var129 "職業別常用労働者数区分14うちパート: 運輸・通信"
capture label variable var130 "職業別常用労働者数区分14うちパート: 生産・労務"
capture label variable var131 "職業別常用労働者数区分14うちパート: その他"
capture label variable var132 "職業別常用労働者数区分14うちパート: 合計"
capture label variable var133 "職業別常用労働者数区分15未充足求人数: 専門・技術"
capture label variable var134 "職業別常用労働者数区分15未充足求人数: 管理"
capture label variable var135 "職業別常用労働者数区分15未充足求人数: 事務"
capture label variable var136 "職業別常用労働者数区分15未充足求人数: 販売"
capture label variable var137 "職業別常用労働者数区分15未充足求人数: サービス"
capture label variable var138 "職業別常用労働者数区分15未充足求人数: 運輸・通信"
capture label variable var139 "職業別常用労働者数区分15未充足求人数: 生産・労務"
capture label variable var140 "職業別常用労働者数区分15未充足求人数: その他"
capture label variable var141 "職業別常用労働者数区分15未充足求人数: 合計"
capture label variable var142 "職業別常用労働者数区分16うちパート: 専門・技術"
capture label variable var143 "職業別常用労働者数区分16うちパート: 管理"
capture label variable var144 "職業別常用労働者数区分16うちパート: 事務"
capture label variable var145 "職業別常用労働者数区分16うちパート: 販売"
capture label variable var146 "職業別常用労働者数区分16うちパート: サービス"
capture label variable var147 "職業別常用労働者数区分16うちパート: 運輸・通信"
capture label variable var148 "職業別常用労働者数区分16うちパート: 生産・労務"
capture label variable var149 "職業別常用労働者数区分16うちパート: その他"
capture label variable var150 "職業別常用労働者数区分16うちパート: 合計"
