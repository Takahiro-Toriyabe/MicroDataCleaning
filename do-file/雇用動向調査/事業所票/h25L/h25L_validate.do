...
if r(N)==_N {
    display as error "Only missing value: {bf:var149} (共通事業所コード)"
}


capture count if var150==.
if r(N)==_N {
    display as error "Only missing value: {bf:var150} (中分類)"
}


capture count if var151==.
if r(N)==_N {
    display as error "Only missing value: {bf:var151} (小分類)"
}
