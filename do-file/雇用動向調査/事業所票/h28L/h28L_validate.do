...
if r(N)==_N {
    display as error "Only missing value: {bf:var15} ((3)「定めあり」から「定めなし」に切り替えられた者)"
}
...
if r(N)==_N {
    display as error "Only missing value: {bf:var21} ((3)「定めあり」から「定めなし」に切り替えられた者)"
}
...
if r(N)==_N {
    display as error "Only missing value: {bf:var27} ((3)「定めあり」から「定めなし」に切り替えられた者)"
}
...
if r(N)==_N {
    display as error "Only missing value: {bf:var33} ((3)「定めあり」から「定めなし」に切り替えられた者)"
}
...
if r(N)==_N {
    display as error "Only missing value: {bf:var149} (打鍵フラグ)"
}
capture assert inlist(var149, 1, .)
if _rc!=0 {
    display as error "WARNING: {bf:var149} (打鍵フラグ) may have invalid values (Check layout sheet)"
}


capture count if var150==.
if r(N)==_N {
    display as error "Only missing value: {bf:var150} (共通事業所コード)"
}


capture count if var151==.
if r(N)==_N {
    display as error "Only missing value: {bf:var151} (中分類)"
}


capture count if var152==.
if r(N)==_N {
    display as error "Only missing value: {bf:var152} (小分類)"
}
