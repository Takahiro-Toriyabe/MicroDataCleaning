...
count if var12==.
if r(N)==_N {
    display as error "Only missing value: {bf:var12} (抽出番号)"
}
...
count if var17==.
if r(N)==_N {
    display as error "Only missing value: {bf:var17} ((3)常用に切り替えられた者)"
}
...
count if var23==.
if r(N)==_N {
    display as error "Only missing value: {bf:var23} ((3)常用に切り替えられた者)"
}
...
count if var55==.
if r(N)==_N {
    display as error "Only missing value: {bf:var55} (イ離職者)"
}
...
count if var101==.
if r(N)==_N {
    display as error "Only missing value: {bf:var101} (専門・技術)"
}


count if var102==.
if r(N)==_N {
    display as error "Only missing value: {bf:var102} (管理)"
}


count if var103==.
if r(N)==_N {
    display as error "Only missing value: {bf:var103} (事務)"
}


count if var104==.
if r(N)==_N {
    display as error "Only missing value: {bf:var104} (販売)"
}


count if var105==.
if r(N)==_N {
    display as error "Only missing value: {bf:var105} (サービス)"
}


count if var106==.
if r(N)==_N {
    display as error "Only missing value: {bf:var106} (保安)"
}


count if var107==.
if r(N)==_N {
    display as error "Only missing value: {bf:var107} (運輸・通信)"
}


count if var108==.
if r(N)==_N {
    display as error "Only missing value: {bf:var108} (生産・労務)"
}


count if var109==.
if r(N)==_N {
    display as error "Only missing value: {bf:var109} (その他)"
}


count if var110==.
if r(N)==_N {
    display as error "Only missing value: {bf:var110} (専門・技術)"
}


count if var111==.
if r(N)==_N {
    display as error "Only missing value: {bf:var111} (管理)"
}


count if var112==.
if r(N)==_N {
    display as error "Only missing value: {bf:var112} (事務)"
}


count if var113==.
if r(N)==_N {
    display as error "Only missing value: {bf:var113} (販売)"
}


count if var114==.
if r(N)==_N {
    display as error "Only missing value: {bf:var114} (サービス)"
}


count if var115==.
if r(N)==_N {
    display as error "Only missing value: {bf:var115} (保安)"
}


count if var116==.
if r(N)==_N {
    display as error "Only missing value: {bf:var116} (運輸・通信)"
}


count if var117==.
if r(N)==_N {
    display as error "Only missing value: {bf:var117} (生産・労務)"
}


count if var118==.
if r(N)==_N {
    display as error "Only missing value: {bf:var118} (その他)"
}


count if var119==.
if r(N)==_N {
    display as error "Only missing value: {bf:var119} (専門・技術)"
}


count if var120==.
if r(N)==_N {
    display as error "Only missing value: {bf:var120} (管理)"
}


count if var121==.
if r(N)==_N {
    display as error "Only missing value: {bf:var121} (事務)"
}


count if var122==.
if r(N)==_N {
    display as error "Only missing value: {bf:var122} (販売)"
}


count if var123==.
if r(N)==_N {
    display as error "Only missing value: {bf:var123} (サービス)"
}


count if var124==.
if r(N)==_N {
    display as error "Only missing value: {bf:var124} (保安)"
}


count if var125==.
if r(N)==_N {
    display as error "Only missing value: {bf:var125} (運輸・通信)"
}


count if var126==.
if r(N)==_N {
    display as error "Only missing value: {bf:var126} (生産・労務)"
}


count if var127==.
if r(N)==_N {
    display as error "Only missing value: {bf:var127} (その他)"
}


count if var128==.
if r(N)==_N {
    display as error "Only missing value: {bf:var128} (専門・技術)"
}


count if var129==.
if r(N)==_N {
    display as error "Only missing value: {bf:var129} (管理)"
}


count if var130==.
if r(N)==_N {
    display as error "Only missing value: {bf:var130} (事務)"
}


count if var131==.
if r(N)==_N {
    display as error "Only missing value: {bf:var131} (販売)"
}


count if var132==.
if r(N)==_N {
    display as error "Only missing value: {bf:var132} (サービス)"
}


count if var133==.
if r(N)==_N {
    display as error "Only missing value: {bf:var133} (保安)"
}


count if var134==.
if r(N)==_N {
    display as error "Only missing value: {bf:var134} (運輸・通信)"
}


count if var135==.
if r(N)==_N {
    display as error "Only missing value: {bf:var135} (生産・労務)"
}


count if var136==.
if r(N)==_N {
    display as error "Only missing value: {bf:var136} (その他)"
}


count if var137==.
if r(N)==_N {
    display as error "Only missing value: {bf:var137} (調査入職者数)"
}


count if var138==.
if r(N)==_N {
    display as error "Only missing value: {bf:var138} (調査離職者数)"
}
