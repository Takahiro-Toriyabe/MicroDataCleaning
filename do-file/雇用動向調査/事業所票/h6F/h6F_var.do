...
capture label variable var22 "常用労働者の異動状況区分1常用名義男(4)減少労働者数: イ離職者"
capture label variable var23 "常用労働者の異動状況区分1常用名義男(4)減少労働者数: ロ転出者等"
...
capture label variable var28 "常用労働者の異動状況区分2臨時・日雇名義男(4)減少労働者数: イ離職者"
capture label variable var29 "常用労働者の異動状況区分2臨時・日雇名義男(4)減少労働者数: ロ転出者等"
...
capture label variable var34 "常用労働者の異動状況区分3常用名義女(4)減少労働者数: イ離職者"
capture label variable var35 "常用労働者の異動状況区分3常用名義女(4)減少労働者数: ロ転出者等"
...
capture label variable var40 "常用労働者の異動状況区分4臨時・日雇い名義女(4)減少労働者数: イ離職者"
capture label variable var41 "常用労働者の異動状況区分4臨時・日雇い名義女(4)減少労働者数: ロ転出者等"
...
capture label variable var46 "常用労働者の異動状況区分5合計(4)減少労働者数: イ離職者"
capture label variable var47 "常用労働者の異動状況区分5合計(4)減少労働者数: ロ転出者等"
...
capture label variable var52 "常用労働者の異動状況区分6うちパートタイム男(4)減少労働者数: イ離職者"
capture label variable var53 "常用労働者の異動状況区分6うちパートタイム男(4)減少労働者数: ロ転出者等"
...
capture label variable var58 "常用労働者の異動状況区分7うちパートタイム女(4)減少労働者数: イ離職者"
capture label variable var59 "常用労働者の異動状況区分7うちパートタイム女(4)減少労働者数: ロ転出者等"
...
capture label variable var64 "常用労働者の異動状況区分8うち出向者(4)減少労働者数: イ離職者"
capture label variable var65 "常用労働者の異動状況区分8うち出向者(4)減少労働者数: ロ転出者等"
