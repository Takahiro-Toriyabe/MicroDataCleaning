...
if r(N)==_N {
    display as error "Only missing value: {bf:var54} (17うち、4~6(10~12)月離職者)"
}


capture count if var55==.
if r(N)==_N {
    display as error "Only missing value: {bf:var55} (18うち、4~6(10~12)月出向者)"
}
...
if r(N)==_N {
    display as error "Only missing value: {bf:var100} (管理的職業従事者)"
}


capture count if var101==.
if r(N)==_N {
    display as error "Only missing value: {bf:var101} (専門的・技術的職業従事者)"
}


capture count if var102==.
if r(N)==_N {
    display as error "Only missing value: {bf:var102} (事務従事者)"
}


capture count if var103==.
if r(N)==_N {
    display as error "Only missing value: {bf:var103} (販売従事者)"
}


capture count if var104==.
if r(N)==_N {
    display as error "Only missing value: {bf:var104} (サービス職業従事者)"
}


capture count if var105==.
if r(N)==_N {
    display as error "Only missing value: {bf:var105} (保安職業従事者)"
}


capture count if var106==.
if r(N)==_N {
    display as error "Only missing value: {bf:var106} (生産工程従事者)"
}


capture count if var107==.
if r(N)==_N {
    display as error "Only missing value: {bf:var107} (輸送・機械運転従事者)"
}


capture count if var108==.
if r(N)==_N {
    display as error "Only missing value: {bf:var108} (建設・採掘従事者)"
}


capture count if var109==.
if r(N)==_N {
    display as error "Only missing value: {bf:var109} (運搬・清掃・包装等従事者)"
}


capture count if var110==.
if r(N)==_N {
    display as error "Only missing value: {bf:var110} (その他の職業従事者)"
}


capture count if var111==.
if r(N)==_N {
    display as error "Only missing value: {bf:var111} (管理的職業従事者)"
}


capture count if var112==.
if r(N)==_N {
    display as error "Only missing value: {bf:var112} (専門的・技術的職業従事者)"
}


capture count if var113==.
if r(N)==_N {
    display as error "Only missing value: {bf:var113} (事務従事者)"
}


capture count if var114==.
if r(N)==_N {
    display as error "Only missing value: {bf:var114} (販売従事者)"
}


capture count if var115==.
if r(N)==_N {
    display as error "Only missing value: {bf:var115} (サービス職業従事者)"
}


capture count if var116==.
if r(N)==_N {
    display as error "Only missing value: {bf:var116} (保安職業従事者)"
}


capture count if var117==.
if r(N)==_N {
    display as error "Only missing value: {bf:var117} (生産工程従事者)"
}


capture count if var118==.
if r(N)==_N {
    display as error "Only missing value: {bf:var118} (輸送・機械運転従事者)"
}


capture count if var119==.
if r(N)==_N {
    display as error "Only missing value: {bf:var119} (建設・採掘従事者)"
}


capture count if var120==.
if r(N)==_N {
    display as error "Only missing value: {bf:var120} (運搬・清掃・包装等従事者)"
}


capture count if var121==.
if r(N)==_N {
    display as error "Only missing value: {bf:var121} (その他の職業従事者)"
}


capture count if var122==.
if r(N)==_N {
    display as error "Only missing value: {bf:var122} (管理的職業従事者)"
}


capture count if var123==.
if r(N)==_N {
    display as error "Only missing value: {bf:var123} (専門的・技術的職業従事者)"
}


capture count if var124==.
if r(N)==_N {
    display as error "Only missing value: {bf:var124} (事務従事者)"
}


capture count if var125==.
if r(N)==_N {
    display as error "Only missing value: {bf:var125} (販売従事者)"
}


capture count if var126==.
if r(N)==_N {
    display as error "Only missing value: {bf:var126} (サービス職業従事者)"
}


capture count if var127==.
if r(N)==_N {
    display as error "Only missing value: {bf:var127} (保安職業従事者)"
}


capture count if var128==.
if r(N)==_N {
    display as error "Only missing value: {bf:var128} (生産工程従事者)"
}


capture count if var129==.
if r(N)==_N {
    display as error "Only missing value: {bf:var129} (輸送・機械運転従事者)"
}


capture count if var130==.
if r(N)==_N {
    display as error "Only missing value: {bf:var130} (建設・採掘従事者)"
}


capture count if var131==.
if r(N)==_N {
    display as error "Only missing value: {bf:var131} (運搬・清掃・包装等従事者)"
}


capture count if var132==.
if r(N)==_N {
    display as error "Only missing value: {bf:var132} (その他の職業従事者)"
}


capture count if var133==.
if r(N)==_N {
    display as error "Only missing value: {bf:var133} (管理的職業従事者)"
}


capture count if var134==.
if r(N)==_N {
    display as error "Only missing value: {bf:var134} (専門的・技術的職業従事者)"
}


capture count if var135==.
if r(N)==_N {
    display as error "Only missing value: {bf:var135} (事務従事者)"
}


capture count if var136==.
if r(N)==_N {
    display as error "Only missing value: {bf:var136} (販売従事者)"
}


capture count if var137==.
if r(N)==_N {
    display as error "Only missing value: {bf:var137} (サービス職業従事者)"
}


capture count if var138==.
if r(N)==_N {
    display as error "Only missing value: {bf:var138} (保安職業従事者)"
}


capture count if var139==.
if r(N)==_N {
    display as error "Only missing value: {bf:var139} (生産工程従事者)"
}


capture count if var140==.
if r(N)==_N {
    display as error "Only missing value: {bf:var140} (輸送・機械運転従事者)"
}


capture count if var141==.
if r(N)==_N {
    display as error "Only missing value: {bf:var141} (建設・採掘従事者)"
}


capture count if var142==.
if r(N)==_N {
    display as error "Only missing value: {bf:var142} (運搬・清掃・包装等従事者)"
}


capture count if var143==.
if r(N)==_N {
    display as error "Only missing value: {bf:var143} (その他の職業従事者)"
}


capture count if var144==.
if r(N)==_N {
    display as error "Only missing value: {bf:var144} (調査入職者数)"
}


capture count if var145==.
if r(N)==_N {
    display as error "Only missing value: {bf:var145} (調査離職者数)"
}


capture count if var146==.
if r(N)==_N {
    display as error "Only missing value: {bf:var146} (調査入職者数用抽出率)"
}


capture count if var147==.
if r(N)==_N {
    display as error "Only missing value: {bf:var147} (調査離職者数用抽出率)"
}
