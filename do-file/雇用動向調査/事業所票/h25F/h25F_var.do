...
capture label variable var15 " イ　入職者"
capture label variable var16 " ロ　転入者等"
capture label variable var17 "（３）「定めあり」から「定めなし」に切り替えられた者"
capture label variable var18 " イ　離職者"
capture label variable var19 " ロ　転出者等"
capture label variable var20 "（５）期末常用労働者"
capture label variable var21 " イ　入職者"
capture label variable var22 " ロ　転入者等"
capture label variable var23 "（３）「定めあり」から「定めなし」に切り替えられた者"
capture label variable var24 " イ　離職者"
capture label variable var25 " ロ　転出者等"
capture label variable var26 "（５）期末常用労働者"
capture label variable var27 " イ　入職者"
capture label variable var28 " ロ　転入者等"
capture label variable var29 "（３）「定めあり」から「定めなし」に切り替えられた者"
capture label variable var30 " イ　離職者"
capture label variable var31 " ロ　転出者等"
capture label variable var32 "（５）期末常用労働者"
capture label variable var33 " イ　入職者"
capture label variable var34 " ロ　転入者等"
capture label variable var35 "（３）「定めあり」から「定めなし」に切り替えられた者"
capture label variable var36 " イ　離職者"
capture label variable var37 " ロ　転出者等"
capture label variable var38 "（５）期末常用労働者"
capture label variable var39 " イ　入職者"
capture label variable var40 " ロ　転入者等"
capture label variable var41 " イ　離職者"
capture label variable var42 " ロ　転出者等"
capture label variable var43 "（５）期末常用労働者"
capture label variable var44 " イ　入職者"
capture label variable var45 " ロ　転入者等"
capture label variable var46 " イ　離職者"
capture label variable var47 " ロ　転出者等"
capture label variable var48 "（５）期末常用労働者"
capture label variable var49 " イ　入職者"
capture label variable var50 " ロ　転入者等"
capture label variable var51 " イ　離職者"
capture label variable var52 " ロ　転出者等"
capture label variable var53 "（５）期末常用労働者"
capture label variable var54 "（２）増加常用労働者  イ　入職者"
capture label variable var55 "（４）減少常用労働者  イ　離職者"
capture label variable var56 "（５）期末常用労働者"
capture label variable var57 "⑰うち、4～6(10～12)月　離職者"
capture label variable var58 "⑱うち、4～6(10～12)月　出向者"
