...
capture label define var36 2 "未就業者(学卒者)" 3 "未就職業者(一般)" 4 "既就業者" 2 "未就業者(学卒者)" 3 "未就職業者(一般)" 4 "未就職業者(一般:うち専修学校卒)" 5 "既就業者" 
...
capture label define var38 1 "農林建業" 2 "鉱業" 3 "建設業" 4 "製造業" 5 "運輸通信業" 6 "卸売・小売業・飲食店" 7 "金融・保険・不動産業" 8 "サービス業" 9 "その他の産業" 
capture label values var38 var38

capture label define var39 1 "1:専門・技術的職業従事者" 2 "2:管理的職業従事者" 3 "3:事務従事者" 4 "4:販売従事者" 5 "5:サービス職業従事者" 6 "6:保安職業従事者" 7 "7:運輸通信従事者" 8 "8:技能工生産工程作業者" 9 "9:その他職業従事者" 
capture label values var39 var39

capture label define var40 1 "雇用者(一般労働者)" 2 "雇用者(パートタイム労働者)" 3 "自営業・家族従事者" 
capture label values var40 var40

capture label define var41 2 "雇用者(一般労働者)" 3 "雇用者(パートタイム労働者)" 4 "自営業・家族従事者" 
capture label values var41 var41

capture label define var42 0 "1,2,3,V・2" 1 "2,3,V・1" 11 "1・1" 
capture label values var42 var42

capture label define var43 0 "1,2・1,2" 11 "1・1" 22 "2・2" 
...
capture label define var46 0 "" 1 "不詳" 2 "対象外" 3 "" 
capture label values var46 var46

capture label define var47 1 "能力・個性・資格が生かせる" 2 "仕事内容に興味があった" 3 "会社の将来性が期待できる" 4 "福利厚生制度・施設が充実している" 5 "給料等収入が多い" 6 "労働時間・休日等の労働条件が良い" 7 "通勤が便利" 8 "前の仕事が合わなかったやりがいを感じられなかった" 9 "前の職場の人間関係が好ましくなかった" 10 "出向・出向からの復帰" 11 "定年・会社都合" 12 "知人の紹介・スカウト等" 13 "Uターン・家庭の事情" 14 "健康上の理由" 15 "その他の理由" 
capture label values var47 var47

capture label define var48 8 "能力・個性・資格が生かせる" 9 "仕事内容に興味があった" 10 "会社の将来性が期待できる" 11 "福利厚生制度・施設が充実している" 12 "給料等収入が多い" 13 "労働時間・休日等の労働条件が良い" 14 "前の仕事が合わなかったやりがいを感じられなかった" 15 "前の職場の人間関係が好ましくなかった" 16 "その他の理由" 17 "通勤が便利" 18 "出向・出向からの復帰" 19 "定年・会社都合" 20 "健康上の理由" 21 "知人の紹介・スカウト等" 22 "Uターン・家庭の事情" 
...
capture label define var50 8 "能力・個性・資格が生かせる" 9 "仕事内容に興味があった" 10 "会社の将来性が期待できる" 11 "福利厚生制度・施設が充実している" 12 "給料等収入が多い" 13 "労働時間・休日等の労働条件が良い" 14 "前の仕事が合わなかったやりがいを感じられなかった" 15 "前の職場の人間関係が好ましくなかった" 16 "その他の理由" 17 "通勤が便利" 18 "出向・出向からの復帰" 19 "定年・会社都合" 20 "健康上の理由" 21 "知人の紹介・スカウト等" 22 "Uターン・家庭の事情" 
...
capture label define var52 8 "能力・個性・資格が生かせる" 9 "仕事内容に興味があった" 10 "会社の将来性が期待できる" 11 "福利厚生制度・施設が充実している" 12 "給料等収入が多い" 13 "労働時間・休日等の労働条件が良い" 14 "前の仕事が合わなかったやりがいを感じられなかった" 15 "前の職場の人間関係が好ましくなかった" 16 "その他の理由" 17 "通勤が便利" 18 "出向・出向からの復帰" 19 "定年・会社都合" 20 "健康上の理由" 21 "知人の紹介・スカウト等" 22 "Uターン・家庭の事情" 
capture label values var52 var52

capture label define var53 1 "積極的のみ" 2 "積極的+その他" 3 "積極的+消極的+その他" 4 "積極的+消極的+その他" 5 "消極的のみ" 6 "積極的+その他" 7 "その他のみ" 
capture label values var53 var53

capture label define var54 1 "3割以上増加" 2 "1割以上3割未満増加" 3 "1割未満の増加" 4 "1割以上3割未満の減少" 5 "3割以上減少" 
capture label values var54 var54

capture label define var56 42 "消費関連産業" 43 "素材関連産業" 44 "機械関連産業" 
