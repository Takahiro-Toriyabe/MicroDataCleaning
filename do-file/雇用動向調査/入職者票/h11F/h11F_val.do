/*----------------------------------------------------------------------
    ...
    Date: 2019/03/07 14:28:35
----------------------------------------------------------------------*/


capture label define var2 1999 "1999" 
...
capture label define var21 1 "北海道" 2 "東北" 3 "北関東" 4 "南関東" 5 "北陸" 6 "東海" 7 "近畿" 8 "京阪神" 9 "山陰" 10 "山陽" 11 "四国" 12 "北九州" 13 "南九州" 14 "不詳" 
...
capture label define var30 1 "専門的・技術的職業従事者" 2 "管理的職業従事者" 3 "事務従事者" 4 "販売従事者" 5 "サービス職業従事者" 6 "保安職業従事者" 7 "運輸・通信従事者" 8 "生産工程・労務作業者" 9 "その他の職業従事者" 
capture label values var30 var30

capture label define var31 1 "仕事の内容チェック済:1~4" 2 "仕事の内容チェック済:7,8" 3 "仕事の内容チェック済:5,6,9" 
...
capture label define var36 1 "北海道" 2 "東北" 3 "北関東" 4 "南関東" 5 "北陸" 6 "東海" 7 "近畿" 8 "京阪神" 9 "山陰" 10 "山陽" 11 "四国" 12 "北九州" 13 "南九州" 14 "不詳" 
capture label values var36 var36

capture label define var38 1 "いる" 2 "いない" 
capture label values var38 var38

capture label define var39 1 "主な生活収入" 2 "家計の補助" 3 "生活水準の向上" 4 "余暇の活用(社会参加、資格の活用等含む)" 5 "その他の理由" 
...
capture label define var41 1 "専門的・技術的職業従事者" 2 "管理的職業従事者" 3 "事務従事者" 4 "販売従事者" 5 "サービス職業従事者" 6 "保安職業従事者" 7 "運輸・通信従事者" 8 "生産工程・労務作業者" 9 "その他の職業従事者" 
capture label values var41 var41

capture label define var42 1 "前職の仕事の内容チェック済:1~4" 2 "前職の仕事の内容チェック済:7,7" 3 "前職の仕事の内容チェック済:5,6,9" 
...
capture label define var49 0 "" 1 "" 2 "" 3 "" 
...
capture label define var51 1 "転職理由チェック済み:01" 2 "転職理由チェック済み:02" 3 "転職理由チェック済み:03" 4 "転職理由チェック済み:04" 5 "転職理由チェック済み:05" 6 "転職理由チェック済み:06" 7 "転職理由チェック済み:10" 8 "転職理由チェック済み:07" 9 "転職理由チェック済み:08" 10 "転職理由チェック済み:11" 11 "転職理由チェック済み:12" 12 "転職理由チェック済み:13" 13 "転職理由チェック済み:14" 14 "転職理由チェック済み:15" 15 "転職理由チェック済み:16" 
...
capture label define var54 1 "能力・個性・資格が活かせる" 2 "仕事の内容に興味があった" 3 "会社の将来性が期待できる" 4 "福利厚生制度・施設が充実している" 5 "給料等収入が多い" 6 "労働時間・休日等の労働条件が良い" 7 "通勤が便利" 8 "前の仕事が合わなかったやりがいを感じられなかった" 9 "前の職場の人間関係が好ましくなかった" 10 "出向・出向からの復帰" 11 "定年・会社都合・契約期間の満了" 12 "知人の紹介・スカウト等" 13 "Uターン・家庭の事情" 14 "健康上の理由" 15 "その他の理由" 
