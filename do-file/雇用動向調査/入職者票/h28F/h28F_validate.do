...
capture assert inlist(var26, 1, 3, .)
if _rc!=0 {
...
capture assert inlist(var27, 1, 3, 5, 7, 9, 11, .)
if _rc!=0 {
...
capture assert inlist(var32, 1, 3, 5, 7, 9, 11, .)
if _rc!=0 {
...
capture assert inlist(var33, 1, 3, 5, .)
if _rc!=0 {
...
capture assert inlist(var37, 13, 15, 17, 19, .)
if _rc!=0 {
...
capture assert inlist(var40, 1, 3, 5, 7, 9, 11, .)
if _rc!=0 {
...
capture assert inlist(var41, 1, .)
if _rc!=0 {
    display as error "WARNING: {bf:var41} (最終学歴不明フラグ) may have invalid values (Check layout sheet)"
}
count if var41==.
if r(N)==_N {
    display as error "Only missing value: {bf:var41} (最終学歴不明フラグ)"
}
