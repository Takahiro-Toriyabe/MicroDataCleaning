...
/*----------------------------------------------------------------------
    ...
    Description:     "年齢チェック済"    "年齢コード"
    Variable Name:  "var29"    "var40" 
    Variable values:
...
/*----------------------------------------------------------------------
    ...
    Variable values:
        ...
        Match data:  1: 新規学卒者(平成28年1月以降卒業), 2: 新規学卒者以外(平成27年12月以前卒業),
