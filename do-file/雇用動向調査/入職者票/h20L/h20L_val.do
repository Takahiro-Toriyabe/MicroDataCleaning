...
capture label define var16 1 "中学卒" 3 "専修学校卒" 5 "大学・大学院(文科系)卒" 
capture label values var16 var16

capture label define var17 1 "平成20年3月新卒" 
...
capture label define var26 1 "一般労働者" 
capture label values var26 var26

capture label define var27 1 "専門的・技術的職業従事者" 3 "事務従事者" 5 "サービス職業従事者" 7 "運輸・通信従事者" 9 "その他の職業従事者" 
...
capture label define var31 1 "農林漁業" 3 "建設業" 5 "電気・ガス・熱供給・水道業" 7 "運輸業" 9 "金融・保険業" 11 "飲食店,宿泊業" 13 "教育,学習支援業" 15 "サービス業" 
capture label values var31 var31

capture label define var32 1 "専門的・技術的職業従事者" 3 "事務従事者" 5 "サービス職業従事者" 7 "運輸・通信従事者" 9 "その他の職業従事者" 
capture label values var32 var32

capture label define var33 1 "雇用者(一般労働者)" 3 "自営業主、家族従業者" 
...
capture label define var36 1 "仕事の内容に興味がない" 3 "職場の人間関係" 5 "収入が少ない" 7 "結婚・出産・育児・介護" 9 "会社都合" 
capture label values var36 var36

capture label define var37 11 "仕事の内容に興味" 13 "会社の将来に期待" 15 "労働条件がよい" 17 "とにかく仕事につきたかった" 
capture label values var37 var37

capture label define var38 1 "増加3割以上" 3 "増加1割未満" 5 "減少1割未満" 7 "減少3割以上" 
