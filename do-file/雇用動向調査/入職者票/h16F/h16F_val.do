capture label define var3 1 "上半期" 07 "下半期"
capture label values var3 var3

capture label define var7 1 "県番号：01" 02 "県番号：02～07" 03 "県番号：08～10,19,20" 04 "県番号：11～14" 05 "県番号：15～18" 06 "県番号：21～24" 07 "県番号：25～30" 08 "県番号：31～35" 09 "県番号：36～39" 10 "県番号：40～47"
capture label values var7 var7

capture label define var8 1 "県番号：01" 02 "県番号：02～07" 03 "県番号：08～10,19,20" 04 "県番号：11～14" 05 "県番号：15～18" 06 "県番号：21～24" 07 "県番号：25,29,30" 08 "県番号：26～28" 09 "県番号：31,32" 10 "県番号：33～35" 11 "県番号：36～39" 12 "県番号：40～42，44" 13 "県番号：43,45～47"
...
capture label define var29 1 "19歳以下" 02 "20～24歳" 03 "24～29歳" 04 "30～34歳" 05 "35～39歳" 06 "40～44歳" 07 "45～49歳" 08 "50～54歳" 09 "55～59歳" 10 "60～64歳" 11 "65歳以上"
capture label values var29 var29

capture label define var30 1 "年齢チェック済：01" 02 "年齢チェック済：02" 03 "年齢チェック済：03" 04 "年齢チェック済：04" 05 "年齢チェック済：05" 06 "年齢チェック済：06" 07 "年齢チェック済：07" 08 "年齢チェック済：08" 09 "年齢チェック済：09" 11 "年齢チェック済：10" 12 "年齢チェック済：11"
...
capture label define var40 1 "ある（入職前１年以内）" 2 "ある（入職前１年以上２年未満）" 3 "ない（入職前２年間）"
...
capture label define var42 3 "就業の経験：2、卒業年度：1" 04 "就業の経験：3、卒業年度：1" 06 "就業の経験：2、卒業年度：2" 07 "就業の経験：3、卒業年度：2" 09 "就業の経験：1、卒業年度：1" 10 "就業の経験：1、卒業年度：2"
...
capture label define var44 2 "就業の経験：1、離職期間：1" 03 "就業の経験：1、離職期間：2" 04 "就業の経験：1、離職期間：3" 05 "就業の経験：1、離職期間：4" 06 "就業の経験：1、離職期間：5" 07 "就業の経験：1、離職期間：V" 09 "就業の経験：2、離職期間：6" 10 "就業の経験：2、離職期間：7" 11 "就業の経験：2、離職期間：V"
capture label values var44 var44

capture label define var48 1 "勤めている" 2 "勤めていない"
capture label values var48 var48

capture label define var49 1 "農林漁業" 02 "鉱業" 03 "建設業" 04 "製造業" 05 "電気・ガス・熱供給・水道業" 06 "情報通信業" 07 "運輸業" 08 "卸売・小売業" 09 "金融・保険業" 10 "不動産業" 11 "飲食店、宿泊業" 12 "医療、福祉" 13 "教育、学習支援業" 14 "複合サービス業" 15 "サービス業" 16 "その他の産業"
...
capture label define var54 0 ""
capture label values var54 var54

capture label define var55 0 ""
capture label values var55 var55

capture label define var56 1 "１５日未満" 2 "１５日～１ヶ月未満" 3 "１ヶ月～３ヶ月未満" 4 "３ヶ月～６ヶ月未満" 5 "６ヶ月～１年未満" 6 "１年～１年６ヶ月未満" 7 "１年６ヶ月～２年未満"
...
capture label define var59 1 "仕事の内容が不満" 02 "能力・個性・資格を生かせない" 03 "職場の人間関係" 04 "会社の将来が不安" 05 "収入が少ない" 06 "労働条件が悪い" 07 "結婚・出産・育児・介護" 08 "定年、契約期間の満了" 09 "会社都合" 10 "その他の理由"
capture label values var59 var59

capture label define var60 1 "前の勤め先を辞めた理由チェック済：01" 02 "前の勤め先を辞めた理由チェック済：02" 03 "前の勤め先を辞めた理由チェック済：03" 04 "前の勤め先を辞めた理由チェック済：04" 05 "前の勤め先を辞めた理由チェック済：05" 06 "前の勤め先を辞めた理由チェック済：06" 07 "前の勤め先を辞めた理由チェック済：07" 08 "前の勤め先を辞めた理由チェック済：08" 09 "前の勤め先を辞めた理由チェック済：09" 10 "前の勤め先を辞めた理由チェック済：10"
capture label values var60 var60

capture label define var61 1 "前の勤め先を辞めた理由チェック済：01" 02 "前の勤め先を辞めた理由チェック済：02" 03 "前の勤め先を辞めた理由チェック済：03" 04 "前の勤め先を辞めた理由チェック済：04" 05 "前の勤め先を辞めた理由チェック済：05" 06 "前の勤め先を辞めた理由チェック済：06" 07 "前の勤め先を辞めた理由チェック済：07" 08 "前の勤め先を辞めた理由チェック済：08" 09 "前の勤め先を辞めた理由チェック済：09" 10 "前の勤め先を辞めた理由チェック済：10"
...
capture label define var64 1 "現在の勤め先を選んだ理由チェック済：11" 02 "現在の勤め先を選んだ理由チェック済：12" 03 "現在の勤め先を選んだ理由チェック済：13" 04 "現在の勤め先を選んだ理由チェック済：14" 05 "現在の勤め先を選んだ理由チェック済：15" 06 "現在の勤め先を選んだ理由チェック済：16" 07 "現在の勤め先を選んだ理由チェック済：17" 08 "現在の勤め先を選んだ理由チェック済：18"
capture label values var64 var64

capture label define var65 1 "増加　３割以上" 2 "増加　１割以上３割未満" 3 "増加　１割未満" 4 "変わらない" 5 "減少　１割未満" 6 "減少　１割以上３割未満" 7 "減少　３割以上"
