...
capture label variable var34 "分類表15"
capture label variable var35 "地区"
capture label variable var36 "都道府県"
capture label variable var37 "在籍の有無"
capture label variable var38 "就業の動機"
capture label variable var39 "前職の産業"
capture label variable var40 "チェック済"
capture label variable var41 "分類表7-2"
capture label variable var42 "チェック済"
capture label variable var43 "分類表25"
capture label variable var44 "分類表31"
capture label variable var45 "分類表32"
capture label variable var46 "離職期間"
capture label variable var47 "前職の従業員数"
capture label variable var48 "転職理由数"
capture label variable var49 "チェック済"
capture label variable var50 "分類表28"
capture label variable var51 "チェック済"
