...
/*----------------------------------------------------------------------
    ...
    Variable values:
        Base data:   *: ,
        Match data:  4.0: ハローワークインターネットサービス,
...
/*----------------------------------------------------------------------
    ...
    Variable values:
        ...
        Match data:  1: 新規学卒者(平成22年1月以降に卒業), 2: 新規学卒者以外(平成21年12月以前に卒業),
...
/*----------------------------------------------------------------------
    ...
    Variable values:
        ...
        Match data:  1: 専門的・技術的職業, 2: 管理的職業, 3: 事務, 4: 販売, 5: サービス業, 6: 保安業, 7: 運輸・通信, 8: 生産工程・労務, 9: その他,
...
/*----------------------------------------------------------------------
    ...
    Variable values:
        ...
        Match data:  1: 専門的・技術的職業, 2: 管理的職業, 3: 事務, 4: 販売, 5: サービス業, 6: 保安業, 7: 運輸・通信, 8: 生産工程・労務, 9: その他, V: 不詳,
...
/*----------------------------------------------------------------------
    ...
    Variable values:
        ...
        Match data:  01: 仕事の内容が不満, 02: 能力・個性・資格を生かせない, 03: 職場の人間関係, 04: 会社の将来が不安, 05: 収入が少ない, 06: 労働条件が悪い, 07: 結婚・出産・育児・介護, 08: 定年・契約期間の満了, 09: 会社の都合, 10: その他の理由(出向等含む), VV: 不詳,
...
/*----------------------------------------------------------------------
    ...
    Variable values:
        ...
        Match data:  11: 仕事の内容に興味, 12: 能力・個性・資格を生かせる, 13: 会社の将来に期待, 14: 収入が多い, 15: 労働条件が良い, 16: 通勤が便利, 17: とにかく仕事に就きたかった, 18: その他の理由(出向等を含む), VV: 不詳,
