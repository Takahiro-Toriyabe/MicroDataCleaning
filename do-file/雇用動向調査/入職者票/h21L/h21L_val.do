...
capture label define var17 1 "新規学卒者(平成22年1月以降に卒業)" 
...
capture label define var27 1 "専門的・技術的職業" 3 "事務" 5 "サービス業" 7 "運輸・通信" 9 "その他" 
...
capture label define var32 1 "専門的・技術的職業" 3 "事務" 5 "サービス業" 7 "運輸・通信" 9 "その他" 
...
capture label define var36 1 "仕事の内容が不満" 3 "職場の人間関係" 5 "収入が少ない" 7 "結婚・出産・育児・介護" 9 "会社の都合" 
capture label values var36 var36

capture label define var37 11 "仕事の内容に興味" 13 "会社の将来に期待" 15 "労働条件が良い" 17 "とにかく仕事に就きたかった" 
