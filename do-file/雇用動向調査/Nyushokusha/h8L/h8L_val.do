...
capture label define var30 1 "専門的・技術的職業従事者" 2 "管理的職業従事者" 3 "事務従事者" 4 "販売従事者" 5 "サービス職業従事者" 6 "保安職業従事者" 7 "運輸・通信従事者" 8 "技能工、採掘・製造・建設作業者及び労務作業者" 9 "その他の職業従事者" 
capture label values var30 var30

capture label define var31 1 "" 2 "" 3 "" 
capture label values var31 var31

capture label define var32 1 "北海道" 2 "東北" 3 "北関東" 4 "南関東" 5 "北陸" 6 "東海" 7 "近畿" 8 "京阪神" 9 "山陰" 10 "山陽" 11 "四国" 12 "北九州" 13 "南九州" 14 "不詳" 
capture label values var32 var32

capture label define var34 1 "いる" 2 "いない" 
capture label values var34 var34

capture label define var35 1 "主な生活収入" 2 "家計の補助" 3 "生活水準の向上" 4 "余暇の活用(社会参加、資格の活用等含む)" 5 "その他の理由" 
capture label values var35 var35

capture label define var36 1 "ある" 2 "ない" 
...
capture label define var39 1 "農林、漁業" 2 "鉱業" 3 "建設業" 4 "製造業" 5 "運輸・通信業" 6 "卸売・小売業・飲食店" 7 "金融・保険業・不動産業" 8 "サービス業" 9 "その他の産業" 
capture label values var39 var39

capture label define var40 1 "専門的・技術的職業従事者" 2 "管理的職業従事者" 3 "事務従事者" 4 "販売従事者" 5 "サービス職業従事者" 6 "保安職業従事者" 7 "運輸・通信従事者" 8 "技能工、採掘・製造・建設作業者及び労務作業者" 9 "その他の職業従事者" 
capture label values var40 var40

capture label define var41 1 "" 2 "" 3 "" 
capture label values var41 var41

capture label define var42 1 "雇用者(一般労働者)" 2 "雇用者(パートタイム労働者)" 3 "自営業主・家族従事者" 
capture label values var42 var42

capture label define var43 2 "" 3 "" 4 "" 
...
capture label define var53 1 "能力・個性・資格が活かせる" 2 "仕事の内容に興味があった" 3 "会社の将来性が期待できる" 4 "福利厚生制度・施設が充実している" 5 "給料等収入が多い" 6 "労働時間・休日等の労働条件が良い" 7 "通勤が便利" 8 "前の仕事が合わなかったやりがいを感じられなかった" 9 "前の職場の人間関係が好ましくなかった" 10 "出向・出向からの復帰" 11 "定年・会社都合・契約期間の満了" 12 "知人の紹介・スカウト等" 13 "Uターン・家庭の事情" 14 "健康上の理由" 15 "その他の理由" 
