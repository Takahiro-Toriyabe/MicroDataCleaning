...
capture label define var14 1 "中学卒" 2 "高校卒" 3 "専修学校卒" 4 "高専・短大卒" 5 "大学(文科系)卒" 6 "大学(理科系)卒" 7 "大学院(文科系)卒" 8 "大学院(理科系)卒" 
capture label values var14 var14

capture label define var15 1 "新規学卒者(平成28年1月以降卒業)" 2 "新規学卒者以外(平成27年12月以前卒業)" 
...
capture label define var24 1 "一般労働者(雇用期間の定めなし)" 2 "一般労働者(雇用期間の定めあり)" 3 "パートタイム労働者(雇用期間の定めなし)" 4 "パートタイム労働者(雇用期間の定めあり)" 
...
capture label define var31 1 "雇用者(一般労働者)(雇用期間の定めなし)" 2 "雇用者(一般労働者)(雇用期間の定めあり)" 3 "雇用者(パートタイム労働者)(雇用期間の定めなし)" 4 "雇用者(パートタイム労働者)(雇用期間の定めあり)" 5 "自営業主・家族従業者" 
...
capture label define var34 1 "仕事の内容が不満" 2 "能力・個性・資格を生かせない" 3 "職場の人間関係" 4 "会社の将来が不安" 5 "収入が少ない" 6 "労働条件が悪い" 7 "結婚" 8 "出産・育児" 9 "介護・看護" 10 "定年・契約期間の満了" 11 "会社の都合" 12 "その他の理由(出向等含む)" 
...
capture label define var38 1 "19歳以下" 2 "20~24歳" 3 "25~29歳" 4 "30~34歳" 5 "35~39歳" 6 "40~44歳" 7 "45~49歳" 8 "50~54歳" 9 "55~59歳" 10 "60~64歳" 11 "65歳以上" 
capture label values var38 var38

capture label define var39 1 "最終学歴不明" 
