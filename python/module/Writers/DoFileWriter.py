...
class DoFileWriterBase:
    ...
    def __WriteHeader__(self):
        self.file.write(
            ...
            self.indent*2 + '3. _rename.do is generated by finding a variable with a similar\n' + \
            ...
            self.indent*2 + '4. In addition, there is no file to make variable values consistent\n' + \
